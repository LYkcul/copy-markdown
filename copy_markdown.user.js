...
(function () {
  ...
  const routes = [
    ...
    },
    {
      ...
      test: (url) => !(url.hash && url.hash.length > 1 && url.hash !== "#main"),
      mount: ".user-nav",
      getContent: async () => {
        return _feInstance.currentData.user.introduction || "复制失败";
      },
      className: "lfe-form-sz-middle lcolor-var-blue-3 copy-markdown-btn",
      classNameSucc: "lfe-form-sz-middle lcolor-var-green-3 copy-markdown-btn",
      classNameErr: "lfe-form-sz-middle lcolor-var-red-3 copy-markdown-btn",
    },
    {
      name: "contest_detail",
